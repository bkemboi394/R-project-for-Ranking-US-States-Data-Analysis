...
```{r Health, Economics ranking combined}
...
Final_rankings <- Factor_rankings_combined %>% 
   mutate("2011" = (`2011_overall_erank`+`2011_overall_hrank`)/2) %>% 
     mutate("2012" = (`2012_overall_erank`+`2012_overall_hrank`)/2) %>% 
     mutate("2013" = (`2013_overall_erank`+`2013_overall_hrank`)/2) %>% 
     mutate("2014" = (`2014_overall_erank`+`2014_overall_hrank`)/2) %>% 
     mutate("2015" = (`2015_overall_erank`+`2015_overall_hrank`)/2) %>% 
     mutate("2016" = (`2016_overall_erank`+`2016_overall_hrank`)/2) %>% 
     mutate("2017" = (`2017_overall_erank`+`2017_overall_hrank`)/2) %>% 
     mutate("2018" = (`2018_overall_erank`+`2018_overall_hrank`)/2) %>% 
     mutate("2019" = (`2019_overall_erank`+`2019_overall_hrank`)/2) %>% 
     mutate("2020" = (`2020_overall_erank`+`2020_overall_hrank`)/2) %>% 
     mutate("10_yr" = (`10yr_overall_erank`+`10yr_overall_hrank`)/2)  
