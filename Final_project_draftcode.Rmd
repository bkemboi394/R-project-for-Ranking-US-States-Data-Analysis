...
health_weighted_ranks <- overall_health_ranking_data %>% 
     ...
     mutate("2020_weighted_rank"=((0.2 * (`2020_ranking.x`))+(0.8*(`2020_ranking.y`)))/2) %>%              mutate("10yr_weighted_rank"=((0.2 * (`10year_ranking.x`))+(0.8*(`10year_ranking.y`)))/2)
...
economics_weighted_ranks <- overall_economics_ranking_data %>% 
     mutate("2011_weighted_rank"=((0.6 * (`2011_ranking.x`))+(0.4*(`2011_ranking.y`)))/2) %>% 
     mutate("2012_weighted_rank"=((0.6 * (`2012_ranking.x`))+(0.4*(`2012_ranking.y`)))/2) %>% 
     mutate("2013_weighted_rank"=((0.6 * (`2013_ranking.x`))+(0.4*(`2013_ranking.y`)))/2) %>% 
     mutate("2014_weighted_rank"=((0.6 * (`2014_ranking.x`))+(0.4*(`2014_ranking.y`)))/2) %>% 
     mutate("2015_weighted_rank"=((0.6 * (`2015_ranking.x`))+(0.4*(`2015_ranking.y`)))/2) %>% 
     mutate("2016_weighted_rank"=((0.6 * (`2016_ranking.x`))+(0.4*(`2016_ranking.y`)))/2) %>% 
     mutate("2017_weighted_rank"=((0.6 * (`2017_ranking.x`))+(0.4*(`2017_ranking.y`)))/2) %>% 
     mutate("2018_weighted_rank"=((0.6 * (`2018_ranking.x`))+(0.4*(`2018_ranking.y`)))/2) %>% 
     mutate("2019_weighted_rank"=((0.6 * (`2019_ranking.x`))+(0.4*(`2019_ranking.y`)))/2) %>% 
     mutate("2020_weighted_rank"=((0.6 * (`2020_ranking.x`))+(0.4*(`2020_ranking.y`)))/2) %>%              mutate("10yr_weighted_rank"=((0.6 * (`10year_ranking.x`))+(0.4*(`10year_ranking.y`)))/2)
...
elecprice_rank_summary1 <- elecprice_rank_summary %>% 
  rename(States = state)
elecprice_rank_summary[17,1] <- "District of Columbia"
...
final_ranks_graduation[24,1] <- "Alabama"
...
mutate("2011" = (`2011_overall_erank`+`2011_overall_hrank`+`2011_edurank`+`2011_overall_irank`+`2011_corrank`)/4)%>%
mutate("2012" = (`2012_overall_erank`+`2012_overall_hrank`+`2012_edurank`+`2012_overall_irank`+`2012_corrank`)/4)%>% 
mutate("2013" = (`2013_overall_erank`+`2013_overall_hrank`+`2013_edurank`+`2013_overall_irank`+`2013_corrank`)/4)%>%
mutate("2014" = (`2014_overall_erank`+`2014_overall_hrank`+`2014_edurank`+`2014_overall_irank`+`2014_corrank`)/4)%>%
mutate("2015" = (`2015_overall_erank`+`2015_overall_hrank`+`2015_edurank`+`2015_overall_irank`+`2015_corrank`)/4)%>% 
mutate("2016" = (`2016_overall_erank`+`2016_overall_hrank`+`2016_edurank`+`2016_overall_irank`+`2016_corrank`)/4)%>% 
mutate("2017" = (`2017_overall_erank`+`2017_overall_hrank`+`2017_edurank`+`2017_overall_irank`+`2017_corrank`)/4)%>% 
mutate("2018" = (`2018_overall_erank`+`2018_overall_hrank`+`2018_edurank`+`2018_overall_irank`+`2018_corrank`)/4)%>% 
mutate("2019" = (`2019_overall_erank`+`2019_overall_hrank`+`2019_edurank`+`2019_overall_irank`+`2019_corrank`)/4)%>% 
mutate("2020" = (`2020_overall_erank`+`2020_overall_hrank`+`2020_overall_irank`)/3) %>% 
mutate("10_yr" = (`10yr_overall_erank`+`10yr_overall_hrank`+`10year_edurank`+`10yr_overall_irank`+ `10yr_corrank`)/4)  
