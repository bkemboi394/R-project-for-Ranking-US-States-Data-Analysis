...
```{r, replacing na}
replacing_na <- graduation_rate2 %>%
replace(graduation_rate2=="---", "NA") 
...
```{r}
sum2011 <- c(72,68,78,81,76,74,83,78,59,71,67,80,84,86,88,83,71,84,83,83,74,77,75,81,82,86,62,86,83,63,77,78,86,80,68,83,77,74,83,86,86,76,87,82,76,78,87,80)

mean2011 <- (sum(sum2011))/48
...
nineyear_graduation <- replacing_na %>%
mutate("10year_mean" =rowMeans(.[ , c( `2011`,`2012`,`2013`,`2014`,`2015`,`2016`,`2017`,`2018`,`2019`)], na.rm = TRUE))
