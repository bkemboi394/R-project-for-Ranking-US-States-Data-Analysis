...
Factor_rankings_combined <- distinct(Factor_rankings_combined)
```
...
```
    ...
    ##  1 North …      1      1      1      1      1      1      1     14     22     16
    ##  2 South …      3      3      2      2      3      3      6     31     28     29
    ##  3 Nebras…      4      5      4      3      2      6      5     11     12     11
    ##  4 Distri…      7      6      7      7      7      4      4      8      8      1
    ##  5 Washin…      6      7      5      5      4      5      3     12     13     15
    ##  6 Wyoming      2      2      3      4      6     10      9     41     35     31
    ##  7 Utah         5      4      6      9      8     20     21      9      9     10
    ##  8 Colora…      9     12      9      6      5      2      2      7      2      8
    ##  9 Minnes…      8     11     13     12     11      9     18      2      7      7
    ## 10 Kansas      10      8     12     14     13     16     13     17     16     13
...
```
    ...
    ##    <chr>                <int>            <int>            <int>            <int>
    ##  1 North D…                 7                8                2               17
    ##  2 South D…                13               22               11                5
    ##  3 Nebraska                 5               15                5               33
    ##  4 Distric…                23                3               44                1
    ##  5 Washing…                18               25               22               13
    ##  6 Wyoming                 14               35                6               19
    ##  7 Utah                     3               38               15               31
    ##  8 Colorado                12               34               33               11
    ##  9 Minneso…                 3                4               25               45
    ## 10 Kansas                  15               23               20               29
...
![](Ranking_USA_States_files/figure-gfm/Plotting%20US%20Map%20showing%20the%20overall%20rankings-1.png)<!-- -->
...
![](Ranking_USA_States_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](Ranking_USA_States_files/figure-gfm/subsetting%20data%20for%20top%20states%20based%20on%2010%20yr%20average%20and%20plotting%20their%20ranks-1.png)<!-- -->
...
![](Ranking_USA_States_files/figure-gfm/subsetting%20data%20for%20most%20improved%20states%20and%20plotting%20their%20ranks-1.png)<!-- -->
...
![](Ranking_USA_States_files/figure-gfm/Generating%20random%20states%20and%20plotting%20their%20graphs%20over%20time-1.png)<!-- -->
...
```
    ...
    ## (Intercept)          -3.65236    4.99461  -0.731  0.46841    
    ...
    ## `10year_edurank`      0.08825    0.04751   1.857  0.06981 .  
...
```
    ...
    ##   4.414  22.727  29.660  29.736  36.642  55.596
...
![](Ranking_USA_States_files/figure-gfm/model%20simulation%20and%20plotting-1.png)<!-- -->

``` r
plot(cor, y)
```

![](Ranking_USA_States_files/figure-gfm/plotting%20corrections%20versus%20overall%20rank%20as%20per%20the%20simulated%20model-1.png)<!-- -->

``` r
plot(edu, y)
```

![](Ranking_USA_States_files/figure-gfm/plotting%20education%20versus%20overall%20rank%20as%20per%20the%20simulated%20model-1.png)<!-- -->
